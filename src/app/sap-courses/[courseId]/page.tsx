...
export default function SAPCourseDetailPage({ params }: PageProps) {
  const resolvedParams = use(params);
  const course = sapCourses.find((c) => c.id === resolvedParams.courseId);
        ...
        <div className="relative container">
          <div className="mx-auto max-w-[800px] pt-8 text-center">
            <span className="mb-4 inline-block rounded-full bg-white/20 px-4 py-1 text-sm font-semibold text-white">
              {course.division === "ECC" ? "SAP ECC" : "SAP S/4 HANA"}
            </span>
