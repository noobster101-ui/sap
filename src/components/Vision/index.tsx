...
const VisionSection = () => {
  return (
    <React.Fragment>
      <section className="bg-gradient-to-r from-blue-50 to-purple-50 py-16 lg:py-24 dark:from-gray-900 dark:to-gray-800">
              ...
              <div className="mb-8 h-full rounded-sm border border-gray-200 bg-white p-8 shadow-md dark:border-gray-700 dark:bg-gray-800">
                ...
                <ul className="space-y-2 text-base text-gray-600 dark:text-gray-300">
                  <li className="flex items-start">
                    ...
                    Detailed explanation of business processes
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="mr-2 h-5 w-5 text-green-500"
